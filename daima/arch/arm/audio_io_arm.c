...
{
    (void)cfg;
    DAIMA_LOGW(TAG, "audio_input_start not implemented");
...
daima_err_t audio_input_read(uint8_t *buf, size_t buf_size, size_t *out_size)
{
    ...
    DAIMA_LOGW(TAG, "audio_input_read not implemented");
    return DAIMA_ERR_INVALID_STATE;
}

void audio_input_stop(void)
{
    DAIMA_LOGW(TAG, "audio_input_stop not implemented");
}

daima_err_t audio_output_start(const audio_stream_cfg_t *cfg)
{
    (void)cfg;
    DAIMA_LOGW(TAG, "audio_output_start not implemented");
    return DAIMA_ERR_INVALID_STATE;
}
...
daima_err_t audio_output_write(const uint8_t *buf, size_t buf_size)
{
    (void)buf;
    (void)buf_size;
    DAIMA_LOGW(TAG, "audio_output_write not implemented");
    return DAIMA_ERR_INVALID_STATE;
}

void audio_output_stop(void)
{
    DAIMA_LOGW(TAG, "audio_output_stop not implemented");
}
...
daima_err_t audio_output_play_wav(const uint8_t *buf, size_t buf_size)
{
    (void)buf;
    (void)buf_size;
    DAIMA_LOGW(TAG, "audio_output_play_wav not implemented");
    return DAIMA_ERR_INVALID_STATE;
}
