 ...
 * - 仅 MIPS 平台使用
 */
#define VISION_SNAPSHOT_DIR     "/tmp/daima_vision"
...
#define CONFIG_DAIMA_MODEL_FALLBACK_ENABLED  MODEL_FALLBACK_ENABLED
#define CONFIG_DAIMA_TODO_ENFORCER_ENABLED   TODO_ENFORCER_ENABLED
...
#define CONFIG_DAIMA_COMPACTION_RECOVERY_ENABLED COMPACTION_RECOVERY_ENABLED
#define CONFIG_DAIMA_SESSION_RECOVERY_ENABLED    SESSION_RECOVERY_ENABLED
