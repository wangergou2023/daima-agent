...
#define DAIMA_MODEL_FALLBACK_ENABLED  1
#define AGENT_EXTENSIONS_ENABLED      1
#define DAIMA_TODO_ENFORCER_ENABLED   1
#define DAIMA_RULES_INJECTION_ENABLED 1
#define DAIMA_PROMETHEUS_INTERVIEW_ENABLED 1
...
#define DAIMA_HASHLINE_ENABLED        1
...
#define CONFIG_DAIMA_MODEL_FALLBACK_ENABLED  DAIMA_MODEL_FALLBACK_ENABLED
#define CONFIG_DAIMA_TODO_ENFORCER_ENABLED   DAIMA_TODO_ENFORCER_ENABLED
#define CONFIG_DAIMA_RULES_INJECTION_ENABLED DAIMA_RULES_INJECTION_ENABLED
#define CONFIG_DAIMA_HASHLINE_ENABLED        DAIMA_HASHLINE_ENABLED
#define CONFIG_DAIMA_SAFE_EDIT_ENABLED       DAIMA_SAFE_EDIT_ENABLED
#ifdef DAIMA_ENABLE_VISION
...
#define DAIMA_SESSION_RECOVERY_ENABLED        1
#define CONFIG_DAIMA_COMPACTION_RECOVERY_ENABLED DAIMA_COMPACTION_RECOVERY_ENABLED
#define CONFIG_DAIMA_SESSION_RECOVERY_ENABLED    DAIMA_SESSION_RECOVERY_ENABLED
