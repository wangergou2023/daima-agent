...
typedef daima_err_t (*agent_hook_on_intent_fn)(struct message *msg);
typedef daima_err_t (*agent_hook_on_prepare_fn)(struct message *msg,
    char *system_prompt, size_t system_prompt_size, cJSON *messages);
typedef daima_err_t (*agent_hook_before_run_fn)(struct message *msg,
    const char **model_override, const char *tools_json);
typedef daima_err_t (*agent_hook_replace_run_fn)(struct message *msg,
