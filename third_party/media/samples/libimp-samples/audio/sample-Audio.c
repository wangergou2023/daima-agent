...
static int IMP_Audio_Encode(void)
{
	...
	/* 使用不同方法进行编码。如果使用系统方法为attr.type=PT_G711A；*/
	/* Use the My method to encoder. if use the system method is attr.type = PT_G711A; */
