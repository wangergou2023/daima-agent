...
#include "sample-common-kernenc.h"
...
int main(int argc, char *argv[])
{
	...
	/* Step.5 停止 kernel encode */
	/* Step.5 Stop kernel encode */
	...
	/* Step.6 获取 kernel 视频流 */
	/* Step.6 Get kernel encode stream */
