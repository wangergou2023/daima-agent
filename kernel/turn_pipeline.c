			     ...
			     int iteration_offset)
{
	...
	err_t err = run_prepared_turn_once(msg, system_prompt, messages, tools_json, cancel_chat_id,
...
void agent_finalize_turn(struct message *msg,
			 ...
			 int iteration_offset)
{
	agent_hooks_trigger_finish(msg, (io_final_text && *io_final_text) ? *io_final_text : "");
