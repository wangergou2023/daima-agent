...
static int skilltool_tool_probe(struct device *dev)
{
    (void)dev;
    return 0;
}

static struct tool_device s_skilltool_device = {
    .name = "skills",
    .description = "统一技能浏览工具。action=list 列出当前已安装技能；action=view 查看某个技能的主说明或关联文件。",
    .input_schema_json = "{\"type\":\"object\"," "\"properties\":{" "\"action\":{\"type\":\"string\",\"description\":\"list 或 view\"}," "\"pattern\":{\"type\":\"string\",\"description\":\"可选过滤关键词；会匹配技能目录名、name、description\"}," "\"channel\":{\"type\":\"string\",\"description\":\"可选通道名；填写后只列公共技能和该通道技能，例如 websocket、feishu、pet、vector\"}," "\"name\":{\"type\":\"string\",\"description\":\"技能目录名，例如 code-review 或 weather\"}," "\"file_path\":{\"type\":\"string\",\"description\":\"可选：技能目录内的相对文件路径；省略时读取 SKILL.md\"}" "}," "\"required\":[\"action\"]}",
};
